...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css"> <!-- Chemin vers le fichier CSS compilé -->
</head>
<body>
    <div class="P4">
        ...
        <main>
            ...
            include 'step-by-step/src/inc/template/step/currentstep.php';
            ?>
