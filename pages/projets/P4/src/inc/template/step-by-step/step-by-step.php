<section class="step-by-step">
    <article class="template-content">
        ...
        <div class="step-loader timeline">
            ...
            <button class="btn-step" onclick="window.location.href='?step=step2_mission_Objectifs'">Étape 2</button>
            <button class="btn-step" onclick="window.location.href='?step=step3_configuration'">Étape 3</button>
