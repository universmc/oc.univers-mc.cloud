<section  class="step0_sommaire">
    <article class="presentation-sommaire">
        ...
        <div class="sommaire-content">
            ...
            <button class="btn-sommaire"><span class="step-circl">6</span><span>Attribut-css</span></button>
            <button class="btn-sommaire"><span class="step-circl">7</span><span>Responsive-design</span></button>
            <button class="btn-sommaire"><span class="step-circl">8</span><span>annimation-sass<</span></button>
            <button class="btn-sommaire"><span class="step-circl">9</span><span>Validation-W3C</span></button>
            <button class="btn-sommaire"><span class="step-circl">10</span><span>Debug-tool</span></button>
            <button class="btn-sommaire"><span class="step-circl">11</span><span>Dev-Skiil</span></button>
        </div>
    </article>
</section>